...
@section('title', 'Novo Serviço - Conecta Bairro')
                ...
                <form method="POST" action="{{ route('servicos.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nome_prestador') is-invalid @enderror" 
                               id="nome_prestador" name="nome_prestador" value="{{ old('nome_prestador') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descricao') is-invalid @enderror" 
                                  ...
                                  placeholder="Descreva seu serviço, experiência e especialidades...">{{ old('descricao') }}</textarea>
                        @error('descricao')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
